...
async def copy_user(client, message):
    if message.reply_to_message and message.reply_to_message.from_user:
        ...
        return await message.edit("⎉ قـم بالـرد على العضو")
    ...
    await message.edit("⎉ جـاري انتحـاله ..")
    ...
    await message.edit("⎉ تـم الانتحـال")


@Client.on_message(filters.command("رجوع$", prefixes=f".") & filters.me)
async def uncopy_user(client, message):
    if not r.get(f'{sudo_id}:copy_user'):
        return await message.edit("⎉ لم تقـم بانتحـال أحـد!")
    await message.edit("⎉ جـاري .. العودة إلـى الإعدادات الافتراضيـة")
    ...
    await message.edit("⎉ تـم الرجوع إلـى الإعدادات الافتراضيـة")
    await name()
